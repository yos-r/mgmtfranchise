...
const OfficePriceChart = () => {
    // Static data for apartment price evolution
    const priceData = [
        { year: '2015', price: 1000 },
        { year: '2016', price: 3400 },
        { year: '2017', price: 3300 },
        ...
        { year: '2024', price: 5679 },
        { year: '2025', price: 8400 },
    ];
        ...
        <Card>
            <CardHeader className=" border-b pb-4">
                            <div className="flex items-center justify-between">
                                <h2 className="text-xl font-bold text-gray-800">Commerces - Prix au m² moyen</h2>
...
export default OfficePriceChart;