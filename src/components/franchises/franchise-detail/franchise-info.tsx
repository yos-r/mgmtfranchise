...
export function FranchiseInfo({ franchise,loadFranchises,contracts }: any) {
          ...
          <div className="grid grid-cols-1 gap-4">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="label-1"> Informations </span>
              </div>
              <div className="space-y-1">
                ...
                <p className="body-1 d">
                  <span className="font-medium">Addresse:</span> {franchise.address}
                </p>
              </div>
            </div>
            {/* <div className="space-y-2">
      ...
      <Card className="col-span-1">
        <CardHeader>
          <div className="flex justify-between items-center">
            ...
            <AddFranchiseContract franchise={franchise} loadFranchises={loadFranchises} />
          </div>
        </CardHeader>
        <CardContent className="space-y-6">
