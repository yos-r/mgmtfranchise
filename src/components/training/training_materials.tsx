...
export default function TrainingMaterials({ eventId, isAdmin = true }) {
...
const handleUpload = async () => {
  ...
  try {
    ...
    const filePath = `training/${eventId}/${fileName}`;
...
const handleDelete = async () => {
  ...
  try {
    ...
    const url = new URL(materialToDelete.url);
    const pathSegments = url.pathname.split('/');
    const bucketName = 'training-materials';
    ...
    toast({
      ...
      description: `${materialToDelete.name} has been removed.`,
    });
    ...
    <Dialog open={uploadDialog} onOpenChange={(open) => {
      ...
      <DialogContent>
        <DialogHeader>
          ...
          <DialogDescription>
            Add training resources for this event.
          </DialogDescription>
        </DialogHeader>
